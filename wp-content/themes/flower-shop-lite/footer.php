...
<div id="footer-wrapper">
    	<div class="container footer">
             <div class="cols-3 widget-column-1">  
              <?php $about_title = get_theme_mod('about_title_default','La vie des plantes');?>	
              <?php if (!empty($about_title)) { ?>
                <h5><?php echo esc_html(pll__($about_title));?></h5>             
			   <?php } ?>
               
			   <?php $about_description = get_theme_mod('about_description','about_description_default'); ?>
                <?php if (!empty($about_description)) { ?>
                <p><?php echo wp_kses_post(pll__($about_description));?></p>
			   <?php } ?>  
              ...
              <?php $newsfeed_title = get_theme_mod('newsfeed_title'); ?>
                ...
                <h5><?php echo esc_html(pll__($newsfeed_title)); ?></h5>            
			  <?php } ?>  
