...
function register_footer_strings() {
    pll_register_string('about_title', get_theme_mod('about_title_default', 'La vie des plantes'), 'Footer');
    pll_register_string('about_description', get_theme_mod('about_description_default', 'La vie des plantes est une entreprise qui vend des kits de plantes à faire pousser, des graines, de la terre, des pots, des pipettes d’arrosage, etc.'), 'Footer');
	pll_register_string('newsfeed_title', get_theme_mod('newsfeed_title', 'Actualités'), 'Footer');
}
